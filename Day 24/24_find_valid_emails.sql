...
and email not like '%[^a-zA-Z0-9_.-]%@[a-zA-Z]%.[a-zA-Z]%' -- removing hash and other symbols
and charindex('.', reverse(email)) between 3 and 4;  -- only 2 or 3 chars present after dot(.)




-- [a-zA-Z] : first character should be alphabetic (upper/lower)
-- [a-zA-Z]% : after first character, we can have any number of characters
